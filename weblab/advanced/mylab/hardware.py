...
def switch_light(number, state):
    if state:
        ...
        print("  Imagine that light {} is turning on!                                  ".format(number+1))
        print("************************************************************************")
        #TODO change off to on
        redis.set('hardware:lights:{}'.format(number), 'off')
    else:
        print("************************************************************************")
        print("  Imagine that light {} is turning off!                                 ".format(number+1))
        print("************************************************************************")
        #TODO change on to off
...
#change to @weblab.task(unique='user')
@weblab.task()
def program_device(code):
    ...
    # TODO change to get_microcontroller_state()
